...
/**
   ...
   \par Leeme:
   LnxCOMM te proporcionar&aacute; acceso al puerto serie de una manera f&aacute;cil. <br> <br>
   LnxCOMM esta capacitado para trabajar tanto en sistemas operativos Gnu-Linux como Windows,
   adem&aacute;s proporciona las formas mas utilizadas para la lectura de datos, como el tipo
   ...
   <ul>    
   	...
   	<li>
   	Puedes seguir viendo mas bibliotecas art&iacute;culos  y dem&aacute;s en:
...
/** \file 
 *  \brief Archivo que selecciona el c&oacute;digo a usar seg&uacute;n el S.O.
 *
 *  Este archivo es el encargado de seleccionar que c&oacute;digo incluir
 *  seg&uacute;n el sistema operativo.<br>
