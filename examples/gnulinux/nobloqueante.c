...
/** \file
 *  \brief Ejemplo de uso de funciones No-Bloqueantes.
 *
 *  La definición #define __LINUX_COM__  de este ejemplo nos dice que debe ser compilado 
 *  en un S.O. de tipo GNU-LINUX.
 */
